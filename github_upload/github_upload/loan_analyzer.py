...
present_value = future_value / (1 + (annual_discount_rate / annual_discount_rate)) ** remaining_months
print(f"Present value of loan is: ${present_value: .2f}")
